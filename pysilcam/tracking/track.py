...
def load_and_process(tracksfile, PIX_SIZE, max_starts=None,
    ...
    tracks = sctracker.post_process(data, PIX_SIZE, track_length_limit=track_length_limit, max_starts=max_starts,
...
def track_process(configfile, datapath, offset=0):
    ...
    sctr.cross_correlation_threshold = settings.Tracking.cross_correlation_threshold
