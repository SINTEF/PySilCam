...
class Ui_STATSTimeEDT(object):
    def setupUi(self, STATSTimeEDT):
        ...
        STATSTimeEDT.setMinimumSize(QtCore.QSize(554, 589))
        STATSTimeEDT.setMaximumSize(QtCore.QSize(554, 589))
        self.dateTimeStart = QtWidgets.QDateTimeEdit(STATSTimeEDT)
        self.dateTimeStart.setGeometry(QtCore.QRect(9, 9, 131, 27))
        self.dateTimeStart.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMinus)
        ...
        self.dateTimeEnd.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMinus)
        ...
        self.PLTwidget.setGeometry(QtCore.QRect(40, 90, 481, 461))
