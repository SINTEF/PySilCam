...
class Ui_SilCam(object):
    def setupUi(self, SilCam):
        ...
        self.menuExport.addAction(self.actionSTATS_to_PJ_csv_converter)
    ...
    def retranslateUi(self, SilCam):
        ...
        self.actionExport_summary_figure.setText(_translate("SilCam", "Summary figure + montage (to png)"))
