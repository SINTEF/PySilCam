...
class Ui_SilCam(object):
    def setupUi(self, SilCam):
        ...
        self.gridLayout.addWidget(self.fig_widget, 1, 0, 1, 3)
        self.pb_ChangeDirectory = QtWidgets.QPushButton(self.centralwidget)
        self.pb_ChangeDirectory.setObjectName("pb_ChangeDirectory")
        self.gridLayout.addWidget(self.pb_ChangeDirectory, 0, 0, 1, 1, QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.statusBar = QtWidgets.QLabel(self.centralwidget)
        self.statusBar.setText("")
        self.statusBar.setObjectName("statusBar")
        self.gridLayout.addWidget(self.statusBar, 0, 1, 1, 2)
